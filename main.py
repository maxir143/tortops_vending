...
def main():
    ...
    layout = [
        ...
        [sg.Text('Time out:'), sg.Slider((20, 100), k='timeOut', size=(0, 2), orientation='h', expand_x=True), sg.Text('Sensitivity:'), sg.Slider((200,3000),400, k='area', size=(0, 2), orientation='h', expand_x=True)],
